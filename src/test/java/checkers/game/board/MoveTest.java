...
class MoveTest {
    private static Stream<Arguments> providePlayers() {
        return Stream.of(
                ...
                Arguments.of(new QuinnStrategy(Color.RED, "")),
                Arguments.of(new QuinnStrategy(Color.BLACK, "")),
                Arguments.of(new QuinnStrategy(Color.GREEN, "")),
                Arguments.of(new QuinnStrategy(Color.BLUE, "")),
                Arguments.of(new QuinnStrategy(Color.WHITE, "")),
                Arguments.of(new QuinnStrategy(Color.YELLOW, ""))
        );
    }
